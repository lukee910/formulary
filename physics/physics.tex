...
Wenn h $\parallel$ k. $\alpha$ und $\alpha$' sind Stufenwinkel, $\alpha$' und $\gamma$ sind Wechselwinkel und $\alpha$ und $\gamma$ sind Scheitelwinkel.

%

\section{Kräftegleichgewicht, statisches Gleichgewicht}
...
\begin{equation}
    s_b = \frac{v_0^2}{2g\mu} = \frac{v^2 - v_0^2}{-2a_b}
\end{equation}
